...
import { Group, Stack, Button, Title, Alert, Table, Center, Loader, TextInput, Text, Card, Pagination } from '@mantine/core';
...
export default function PreviewOfTypes() {
  ...
  return (
    <Stack p="md">
      <AddTypeModal opened={opened} onClose={() => { close(); getTypes(); }} />
      {selectedTypeId !== '' ? (
        <EditTypeModal
          opened={editOpened}
          onClose={() => { closeEdit(); getTypes(); }}
